...
<Tabs>
  <TabItem value="hostpath" label="HostPath" default>
    <img src={require('/img/media-and-downloads/dataset-mount-hostpath.png').default} alt="hostpath" />
  </TabItem>
  <TabItem value="nfs" label="NFS">
    <img src={require('/img/media-and-downloads/dataset-mount-nfs.png').default} alt="nfs" />
  </TabItem>
</Tabs>
